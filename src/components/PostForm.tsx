    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          style={{
            background: content.trim() && projectName.trim()
              ? "var(--accent)"
              : "var(--accent-dim)",
            color: content.trim() && projectName.trim() ? "white" : "var(--text-muted)",
            cursor: content.trim() && projectName.trim() ? "pointer" : "not-allowed",
          }}
        >
          <Send size={14} />
          <span>進捗を記録する</span>
